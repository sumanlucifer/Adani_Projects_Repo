sap.ui.define([
    ...
    return BaseController.extend("com.agel.mmts.storeinchargereceivedpo.controller.LandingPage", {
        formatter: formatter,
        ...
        onViewLineItemsPress: function (oEvent) {
            ...
            if (!this.pDialog) {
                this.pDialog = Fragment.load({
                    ...
                    name: "com.agel.mmts.storeinchargereceivedpo.view.fragments.landingPage.ViewLineItemsDialog",
