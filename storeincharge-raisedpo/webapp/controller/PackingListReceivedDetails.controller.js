sap.ui.define([
    ...
    function (BaseController, JSONModel, Filter, FilterOperator, Fragment, Sorter, Device, History, ColumnListItem, Input, jquery, MessageBox, MessageToast, formatter) {
        "use strict";
        return BaseController.extend("com.agel.mmts.storeinchargeraisedpo.controller.PackingListReceivedDetails", {
            formatter: formatter,
            ...
            onInit: function () {
                ...
                this.oRouter.getRoute("RouteDetailsReceivedPage").attachPatternMatched(this._onObjectMatched, this);
