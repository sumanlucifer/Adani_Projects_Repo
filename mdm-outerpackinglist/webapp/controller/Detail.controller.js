sap.ui.define([
    ...
    return BaseController.extend("com.agel.mmts.mdmouterpackinglist.controller.Detail", {
        ...
        _onObjectMatched: function (oEvent) {
            ...
            if (this.sPackingListID === "new") {
                ...
                this._oNewContext = this.mainModel.createEntry("/MasterOuterPackagingTypeSet", {
                    groupId: "createGroup",
                    properties: {
                        ID: "",
                        Name: "",
                ...
                this._bindView("/MasterOuterPackagingTypeSet" + this.sPackingListID);
                this.getViewModel("objectViewModel").setProperty("/idBtnDelete", true);
            }
        },
        ...
        onSave: function () {
            ...
            var Dimension = this.byId("DimensionEdit").getValue();
            if ( Name == "" ){
                MessageBox.error("Please enter name");
                return;
            }
            if ( Dimension == "" ){
                MessageBox.error("Please enter dimension");
                return;
            }
            var oPayload = {};
            oPayload.Name = Name;
            oPayload.Dimension = Dimension;
            if (this.sPackingListID === "new") {
                MessageBox.confirm("Do you want create new packing list type "+Name+"?",{
				    ...
				    onClose: function (oAction) { 
                        if ( oAction == "YES" ){
                            ...
                            that.mainModel.create("/MasterOuterPackagingTypeSet", oPayload, {
