		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RegenerateQRCode-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RegenerateQRCode-display": {
								"semanticObject": "RegenerateQRCode",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.agel.mmts.regenerateqrcode",
									"url": sap.ui.require.toUrl("com/agel/mmts/regenerateqrcode")
								}
							}
						}
					}
