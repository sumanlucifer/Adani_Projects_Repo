			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NewVendor-display": {
								"semanticObject": "NewVendor",
								"action": "display",
								"description": "A new vendor application.",
								"title": "New Vendor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.agel.mmts.newvendor",
									"url": sap.ui.require.toUrl("com/agel/mmts/newvendor")
								}
							}
						}
					}
