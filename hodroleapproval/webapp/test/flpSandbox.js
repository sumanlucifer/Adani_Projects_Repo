		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HOD Role Approval",
									"targetURL": "#HODRoleApproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HODRoleApproval-display": {
								"semanticObject": "HODRoleApproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.agel.mmts.hodroleapproval",
									"url": sap.ui.require.toUrl("com/agel/mmts/hodroleapproval")
								}
							}
						}
					}
