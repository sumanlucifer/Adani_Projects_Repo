            ...
            _showObject: function (oItem) {
                var sObjectPath = oItem.getBindingContext().sPath,
                    oPODetails = {
                        ...
                        CreatedAt: oItem.getBindingContext().getObject().CreatedAt,
                        POReleaseDate: oItem.getBindingContext().getObject().POReleaseDate
                    }
                this.getRouter().navTo("RoutePODetailPage", {
                    PODetails: JSON.stringify(oPODetails)
                });
            },
