sap.ui.define([
    ...
    return BaseController.extend("com.agel.mmts.storetotalorder.storetotalorder.controller.LandingPage", {
        formatter: formatter,
        ...
        onViewLineItemsPress: function (oEvent) {
            ...
            if (!this.pDialog) {
                this.pDialog = Fragment.load({
                    ...
                    name: "com.agel.mmts.storetotalorder.storetotalorder.view.fragments.landingPage.ViewLineItemsDialog",
