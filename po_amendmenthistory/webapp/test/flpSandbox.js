		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Po Amendment History",
									"targetURL": "#PoAmendmentHistory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PoAmendmentHistory-display": {
								"semanticObject": "PoAmendmentHistory",
								"action": "display",
								"description": "A Fiori application for Po Amendment History",
								"title": "Po Amendment History",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.agel.mmts.poamendmenthistory",
									"url": sap.ui.require.toUrl("com/agel/mmts/poamendmenthistory")
								}
							}
						}
					}
