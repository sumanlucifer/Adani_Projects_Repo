		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Self Role Assignment",
									"targetURL": "#SelfRoleAssignment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SelfRoleAssignment-display": {
								"semanticObject": "SelfRoleAssignment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.agel.mmts.selfroleassignment",
									"url": sap.ui.require.toUrl("com/agel/mmts/selfroleassignment")
								}
							}
						}
					}
